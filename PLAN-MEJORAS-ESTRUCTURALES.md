...
- [x] 8.6: eslint limpio + build OK + E2E sin DB 7/7 (4 rutas 401 sin sesión, admin businesses intacto, /editorial 200, EventsTab en bundle). ⏳ E2E completo con DB (CRUD real + visual) pendiente de cadena Neon en `.env` (workspace restaurado de snapshot viejo la perdió)
