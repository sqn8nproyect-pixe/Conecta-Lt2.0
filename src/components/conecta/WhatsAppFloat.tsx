...
//
// Si el número cambia algún día, basta editar WHATSAPP_NUMBER.

const WHATSAPP_NUMBER = '584220117206'; // +58 422-0117206, sin "+" ni símbolos
const WHATSAPP_MESSAGE = encodeURIComponent(
  'Hola CONECTA-LT, quiero hacer una consulta.',
);
