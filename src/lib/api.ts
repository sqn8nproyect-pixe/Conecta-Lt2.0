...
/** "Eliminar conversación" (v2, eliminación TOTAL): desaparece para
 *  TODOS los participantes y los mensajes se purgan definitivamente;
 *  nada reaparece. ADMIN/MODERATOR puede además eliminar ajenas. */
